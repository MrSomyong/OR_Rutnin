...
public sealed class SQLHelper
{
    ...
    // This method provides no access to output parameters or the stored procedure' s return value parameter.
    // e.g.:  
    // Dim result As Integer = NatuchHelper.ExecuteNonQuery(trans, "PublishOrders", 24, 36)
    // Parameters:
    // -transaction - a valid SqlTransaction 
    // -spName - the name of the stored procedure 
    // -parameterValues - an array of objects to be assigned as the input values of the stored procedure 
    ...
    // the connection string. 
    // e.g.:  
    // Dim ds As DataSet = NatuchHelper.ExecuteDataset("", commandType.StoredProcedure, "GetOrders")
    // Parameters:
    // -connectionString - a valid connection string for a SqlConnection
    // -commandType - the CommandType (stored procedure, text, etc.)
    // -commandText - the stored procedure name or T-SQL command
    ...
    public static int ExecuteNonQueryTypedParams(string connectionString, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
        }
    ...
    public static int ExecuteNonQueryTypedParams(SqlConnection connection, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);

        }
        else
        {
            functionReturnValue = ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    #endregion
    ...
    public static DataSet ExecuteDatasetTypedParams(string connectionString, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);

        }
        else
        {
            functionReturnValue = ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);

        }
        else
        {
            functionReturnValue = ExecuteDataset(connection, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);

        }
        else
        {
            functionReturnValue = ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    #endregion
    ...
    public static SqlDataReader ExecuteReaderTypedParams(string connectionString, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteReader(connection, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteReader(transaction, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    #endregion
    ...
    public static object ExecuteScalarTypedParams(string connectionString, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static object ExecuteScalarTypedParams(SqlConnection connection, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteScalar(connection, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static object ExecuteScalarTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    #endregion
    ...
    public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            functionReturnValue = ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
        }
        return functionReturnValue;
    }
    ...
    public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, string spName, DataRow dataRow)
    {
        ...
        if (((dataRow != null) && dataRow.ItemArray.Length > 0))
        {
            ...
            functionReturnValue = ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
...
{
    #region "Constructors && Variable"
    private string _strConn = "";
    public MSSQLConnectionString()
    {
        _strConn = System.Configuration.ConfigurationManager.AppSettings["ConnStrConfig"].ToString();
    }
    public MSSQLConnectionString(string strConn)
    {
        _strConn = strConn;
    }
    #endregion
    ...
    {
        return System.Configuration.ConfigurationManager.AppSettings["ConnStrConfig"].ToString();
    }
    public static string GetConnectionString(string AppConnstr)
    {
        return System.Configuration.ConfigurationManager.AppSettings[AppConnstr].ToString();
    }
...
namespace DAO
{
    public sealed class DALServices
    {

        #region "Parameter"
        public SqlParameter CreateParameter(string ParameterName, object Value, SqlDbType sqlDataType)
        {
            SqlParameter Param = new SqlParameter(ParameterName, sqlDataType);
            Param.Value = Value;
            return Param;
        }
        #endregion
        ...
        public DALServices()
        {
            strConn = MSSQLConnectionString.GetConnectionString();
        }
        public DALServices(string xConnectionString)
        {
            strConn = MSSQLConnectionString.GetConnectionString(xConnectionString);
        }
        ...
        public DataSet ExecuteDataset(string spName, params object[] parameterValues)
        {
            ...
            {
                // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                commandParameters = SqlHelperParameterCache.GetSpParameterSet(strConn, spName);
            ...
            {
                return ExecuteDataset(strConn, CommandType.StoredProcedure, spName);
            }
        }
        // ExecuteDataset
        ...
        public DataSet ExecuteDataset(CommandType commandType, string commandText)
        {
            ...
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteDataset(strConn, commandType, commandText, (SqlParameter[])null);
        }
        // ExecuteDataset
        ...
        public SqlDataReader ExecuteReader(string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && parameterValues.Length > 0)
            {
                ...
                // Call the overload that takes an array of SqlParameters
                return ExecuteReader(strConn, CommandType.StoredProcedure, spName, commandParameters);
                // Otherwise we can just call the SP without params
            }
            else
            {
                return ExecuteReader(strConn, CommandType.StoredProcedure, spName);
            }
        }
        // ExecuteReader
        ...
        {
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteScalar(strConn, commandType, commandText, (SqlParameter[])null);
        }
        // ExecuteScalar
        ...
        public object ExecuteScalar(string spName, params object[] parameterValues)
        {
            ...
            {
                return ExecuteScalar(strConn, CommandType.StoredProcedure, spName);
            }
        }
        // ExecuteScalar
        ...
        public int ExecuteNonQuery(string spName, params object[] parameterValues)
        {
            ...
            {
                return ExecuteNonQuery(strConn, CommandType.StoredProcedure, spName);
            }
        }
        // ExecuteNonQuery
        ...
        public int ExecuteNonQueryTypedParams(string spName, DataRow dataRow)
        {
            ...
            {
                // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(strConn, spName);

                // Set the parameters values
                AssignParameterValues(commandParameters, dataRow);

                functionReturnValue = ExecuteNonQuery(strConn, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                functionReturnValue = ExecuteNonQuery(strConn, CommandType.StoredProcedure, spName);
            }
            return functionReturnValue;
        }
        ...
        public DataSet ExecuteDatasetTypedParams(string spName, DataRow dataRow)
        {
            ...
            if (((dataRow != null) && dataRow.ItemArray.Length > 0))
            {
                ...
                functionReturnValue = ExecuteDataset(strConn, CommandType.StoredProcedure, spName, commandParameters);

            }
            else
            {
                functionReturnValue = ExecuteDataset(strConn, CommandType.StoredProcedure, spName);
            }
            return functionReturnValue;
        }
        ...
        public SqlDataReader ExecuteReaderTypedParams(string spName, DataRow dataRow)
        {
            ...
            if (((dataRow != null) && dataRow.ItemArray.Length > 0))
            {
                ...
                functionReturnValue = ExecuteReader(strConn, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                functionReturnValue = ExecuteReader(strConn, CommandType.StoredProcedure, spName);
            }
            return functionReturnValue;
        }
        ...
        public object ExecuteScalarTypedParams(string spName, DataRow dataRow)
        {
            ...
            if (((dataRow != null) && dataRow.ItemArray.Length > 0))
            {
                ...
                functionReturnValue = ExecuteScalar(strConn, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                functionReturnValue = ExecuteScalar(strConn, CommandType.StoredProcedure, spName);
            }
            return functionReturnValue;
        }
        ...
        public void ExecCreateCommand(DataSet dataSet, string StrSql, string TblName)
        {
            if ((strConn == null || strConn.Length == 0))
                throw new ArgumentNullException("connectionString");
            if ((dataSet == null))
