...
namespace DAL
{
    class DAVT_VNMEDICINE : DataAccess
    {
        public DAVT_VNMEDICINE() { }
        public DAVT_VNMEDICINE(DatabaseInfo dbInfo) { this.DbInfo = dbInfo; }
        public DAVT_VNMEDICINE(System.Data.IDbTransaction useTransaction)
        {
            this.useTransaction = true; this.transaction = useTransaction;
            this.connection = useTransaction.Connection;
        }
        public DAVT_VNMEDICINE(DatabaseInfo dbInfo, System.Data.IDbTransaction useTransaction)
        {
            this.DbInfo = dbInfo; this.useTransaction = true; this.transaction = useTransaction;
            this.connection = useTransaction.Connection;
        }
        
        internal List<VT_VNMEDICINE> SearchByKey(VT_VNMEDICINE _VT_VNMEDICINE)
        {
            List<VT_VNMEDICINE> retValue = new List<VT_VNMEDICINE>();
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append(" select m.*,ac.*  from [dbo].VT_VNMEDICINE m left join dbo.VT_ACTIVITYCODE ac on m.CHARGECODE = ac.Activity ");
        ...
        internal VT_VNMEDICINE GetVT_VNMEDICINEByKey(VT_VNMEDICINE _VT_VNMEDICINE)
        {
            VT_VNMEDICINE VT_VNMEDICINE = new VT_VNMEDICINE();
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append(" select  a.*  from [dbo].VT_VNMEDICINE a ");
        ...
        internal ReturnValue CXLVNMEDICINE(VT_VNMEDICINE _VT_VNMEDICINE)
        {
            ReturnValue retVal = new ReturnValue();
            try
            {
                StringBuilder sbQuery = new StringBuilder();
                sbQuery.Append("UPDATE [dbo].[VNMEDICINE] SET ");
                sbQuery.Append(" CXLDATETIME = GETDATE()");
                sbQuery.Append(" ,CXLBYUSERCODE = @CXLBYUSERCODE");
                sbQuery.Append(" ,REVERSE = 0 , TYPEOFCHARGE = 3 ");
        ...
        internal bool CheckDup(VT_VNMEDICINE _VT_VNMEDICINE)
        {
            bool retVal = false;
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append("select count(*) as num from [dbo].[VNMEDICINE] ");
        ...
        internal ReturnValue Insert(VT_VNMEDICINE _VT_VNMEDICINE)
        {
            ReturnValue retVal = new ReturnValue();
            try
            {
                ...
                sbInsert.Append("Select @i = coalesce(MAX(SUBSUFFIX), 0) + 1 FROM [dbo].[VNMEDICINE] ");
                sbInsert.Append("where VISITDATE = @VISITDATE and VN = @VN and SUFFIX = @SUFFIX ; ");
                sbInsert.Append(" INSERT INTO [dbo].[VNMEDICINE] (");
        ...
        internal ReturnValue UpdateVNMEDICINE(VT_VNMEDICINE _VT_VNMEDICINE)
        {
            ReturnValue retVal = new ReturnValue();
            try
            {
