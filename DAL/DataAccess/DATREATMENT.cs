...
namespace DAL
{
    class DATREATMENT : DataAccess
    {
        DatabaseInfo appConnDBInfo = null;

        public DATREATMENT() { }
        public DATREATMENT(DatabaseInfo dbInfo) { this.DbInfo = dbInfo; }
        public DATREATMENT(DatabaseInfo dbInfo, DatabaseInfo appConnDBInfo) { this.DbInfo = dbInfo; this.appConnDBInfo = appConnDBInfo ; }
        public DATREATMENT(System.Data.IDbTransaction useTransaction)
        {
            this.useTransaction = true; this.transaction = useTransaction;
            this.connection = useTransaction.Connection;
        }
        public DATREATMENT(DatabaseInfo dbInfo, System.Data.IDbTransaction useTransaction)
        {
        ...
        internal List<TREATMENT> GetTREATMENTByGroupMethodCode(TREATMENT treatment)
        {
            ...
            try
            {
                ...
                strQuery.Append(" select t.VISITDATE , t.VN , t.SUFFIX , t.SUBSUFFIX , t.TREATMENTCODE as ITEMCODE , t.TREATMENTNAME as ITEMNAME , t.AMT, t.QTY , t.GROUPREQUESTCODE , 'Treatment' as GroupType , t.CHARGECODE ,ac.* from VT_VNTREAT t ");
                ...
                strQuery.Append(" select m.VISITDATE , m.VN , m.SUFFIX , m.SUBSUFFIX , m.MEDICINECODE as ITEMCODE , ISNULL(NULLIF(m.MEDICINE_THAINAME, ''), m.MEDICINE_ENGLISHNAME) as ITEMNAME , m.AMT, m.QTY , '' as GROUPREQUESTCODE , 'Medicine' as GroupType , m.CHARGECODE ,ac.*  from VT_VNMEDICINE m  left join dbo.VT_ACTIVITYCODE ac on m.CHARGECODE = ac.Activity ");
        ...
        internal List<TREATMENT> GetAllItemCharge(TREATMENT treatment)
        {
            ...
            try
            {
                ...
                strQuery.Append(" select t.VISITDATE , t.VN , t.SUFFIX , t.SUBSUFFIX , t.TREATMENTCODE as ITEMCODE , t.TREATMENTNAME as ITEMNAME , t.AMT, t.QTY , t.GROUPREQUESTCODE , 'Treatment' as GroupType , t.CHARGECODE  from VT_VNTREAT t ");
                ...
                //strQuery.Append(" order by SUBSUFFIX");
                strQuery.Append(" union ");
                strQuery.Append(" select m.VISITDATE , m.VN , m.SUFFIX , m.SUBSUFFIX , m.MEDICINECODE as ITEMCODE , CASE WHEN m.MEDICINE_THAINAME <> '' and  m.MEDICINE_THAINAME IS NOT NULL THEN m.MEDICINE_THAINAME ELSE m.MEDICINE_ENGLISHNAME END as ITEMNAME , m.AMT, m.QTY , '' as GROUPREQUESTCODE , 'Medicine' as GroupType , m.CHARGECODE from VT_VNMEDICINE m ");
                strQuery.Append(" where  m.VN = @VN");
                strQuery.Append(" and m.VISITDATE = @VISITDATE ");
                strQuery.Append(" and m.SUFFIX = @SUFFIX");
                strQuery.Append(" and m.CXLDATETIME IS NULL ");
        ...
        internal List<TREATMENT> GetAllTREATMENT(TREATMENT treatment , bool isDeleted)
        {
            ...
            try
            {
                ...
                strQuery.Append(" SELECT tm.* , ac.ActivityName ");
                strQuery.Append(" FROM ( ");
                strQuery.Append(" select t.VISITDATE , t.VN , t.SUFFIX , t.SUBSUFFIX , t.TREATMENTCODE as ITEMCODE , t.TREATMENTNAME as ITEMNAME , t.AMT, t.QTY , t.GROUPREQUESTCODE , 'Treatment' as GroupType , t.CHARGECODE , t.CXLDATETIME , 0.0 as UNITPRICE from VT_VNTREAT t ");
                strQuery.Append(" left join VT_TREATMENTCODE tc on t.TREATMENTCODE = tc.CODE ");
                strQuery.Append(" where  t.VN = @VN");
                strQuery.Append(" and t.VISITDATE = @VISITDATE");
                strQuery.Append(" and t.SUFFIX = @SUFFIX");
                ...
                strQuery.Append(" from VT_VNMEDICINE m ");
                strQuery.Append(" where  m.VN = @VN");
                strQuery.Append(" and m.VISITDATE = @VISITDATE ");
                strQuery.Append(" and m.SUFFIX = @SUFFIX");
                if (isDeleted == false)
