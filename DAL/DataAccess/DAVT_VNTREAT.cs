...
namespace DAL
{
    class DAVT_VNTREAT : DataAccess
    {
        DatabaseInfo AppConnDBInfo = null;

        public DAVT_VNTREAT() { }
        public DAVT_VNTREAT(DatabaseInfo dbInfo) { this.DbInfo = dbInfo; }
        public DAVT_VNTREAT(DatabaseInfo dbInfo, DatabaseInfo appConnDBInfo) { this.DbInfo = dbInfo; this.AppConnDBInfo = appConnDBInfo; }
        public DAVT_VNTREAT(System.Data.IDbTransaction useTransaction)
        {
            this.useTransaction = true; this.transaction = useTransaction;
            this.connection = useTransaction.Connection;
        }
        public DAVT_VNTREAT(DatabaseInfo dbInfo, System.Data.IDbTransaction useTransaction)
        {
            this.DbInfo = dbInfo; this.useTransaction = true; this.transaction = useTransaction;
            this.connection = useTransaction.Connection;
        }

        internal List<VT_VNTREAT> SearchByKey(VT_VNTREAT _VT_VNTREAT)
        {
            List<VT_VNTREAT> retValue = new List<VT_VNTREAT>();
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append(" select t.*,ac.*  from dbo.VT_VNTREAT t  left join dbo.VT_ACTIVITYCODE ac on t.CHARGECODE = ac.Activity");
                ...
                while (query.Read())
                {
                    VT_VNTREAT VT_VNTREAT = new VT_VNTREAT();
        ...
        internal List<VT_VNTREAT> SearchByKey(VT_VNTREAT _VT_VNTREAT , bool isDF)
        {
            List<VT_VNTREAT> retValue = new List<VT_VNTREAT>();
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append(" select t.*,ac.*  from dbo.VT_VNTREAT t ");
        ...
        internal List<VT_VNTREAT> DFTreatmentChargeAll(VT_VNTREAT _VT_VNTREAT)
        {
            List<VT_VNTREAT> retValue = new List<VT_VNTREAT>();
            try
            {
        ...
        internal List<VT_VNTREAT> GetAllVNTreatByKey(VT_VNTREAT _VT_VNTREAT,bool isDeleted)
        {
            List<VT_VNTREAT> retValue = new List<VT_VNTREAT>();
            try
            {
        ...
        internal List<VT_VNTREAT> GetAllVNTreatByKey(VT_VNTREAT _VT_VNTREAT, bool isDeleted, bool isDF)
        {
            List<VT_VNTREAT> retValue = new List<VT_VNTREAT>();
            try
            {
        ...
        internal VT_VNTREAT GetVT_VNTREATByKey(VT_VNTREAT _VT_VNTREAT)
        {
            VT_VNTREAT VT_VNTREAT = new VT_VNTREAT();
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append(" select  a.*  from dbo.VT_VNTREAT a ");
        ...
        internal ReturnValue CXLVNTREAT(VT_VNTREAT _VT_VNTREAT)
        {
            ReturnValue retVal = new ReturnValue();
            try
            {
                StringBuilder sbQuery = new StringBuilder();
                sbQuery.Append("UPDATE dbo.VNTREAT SET ");
                sbQuery.Append(" CXLDATETIME = GETDATE()");
                sbQuery.Append(" ,CXLBYUSERCODE = @CXLBYUSERCODE");
                sbQuery.Append(" ,REVERSE = 0 ");
        ...
        internal ReturnValue UpdateVNTREAT(VT_VNTREAT _VT_VNTREAT)
        {
            ReturnValue retVal = new ReturnValue();
            try
            {
        ...
        internal bool CheckDup(VT_VNTREAT _VT_VNTREAT)
        {
            bool retVal = false;
            try
            {
                StringBuilder strQuery = new StringBuilder();
                strQuery.Append("select count(*) as num from dbo.VNTREAT ");
        ...
        internal ReturnValue Insert(VT_VNTREAT _VT_VNTREAT)
        {
            ReturnValue retVal = new ReturnValue();
            try
            {
                ...
                sbInsert.Append("Select @i = coalesce(MAX(SUBSUFFIX), 0) + 1 FROM  VNTREAT ");
                sbInsert.Append("where VISITDATE = @VISITDATE and VN = @VN and SUFFIX = @SUFFIX ; ");
                sbInsert.Append(" INSERT INTO  dbo.VNTREAT (");
        ...
        internal double GetTotalTreatmentPrice(VT_VNTREAT _VT_VNTREAT, int statusType)
        {
            ...
            try
            {
                ...
                strQuery.Append(" FROM dbo.VNTREAT  t ");
        ...
        internal double GetTotalTreatmentPriceAll(VT_VNTREAT _VT_VNTREAT, int statusType)
        {
            double retVal = default(double);
            try
            {
