<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RoomTypeProce.aspx.cs" Inherits="solution.Setup.RoomTypeProce" %>
                            ...
                            <asp:GridView ID="gvSetup" runat="server" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                                        <ItemTemplate>
                                            <asp:HiddenField ID="hdRoomTypeID" runat="server" Value='<%# Bind("ID") %>' />
                                            <asp:HiddenField ID="hdRoomType" runat="server" Value='<%# Bind("CodeType") %>' />
                                            <asp:Label ID="lblRoomTypeName" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                        </ItemTemplate>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card card-register mx-auto mt-3">
                                    <div class="card-header badge-warning">
                                        <asp:Label Font-Bold="true" ID="lblRoomType" runat="server"></asp:Label>
                                    ...
                                    <div class="card-body" id="divSub" runat="server">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox runat="server" ID="txtProcedureCode" CssClass="form-control form-control-sm"></asp:TextBox>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <ContentTemplate>--%>
                                            <asp:GridView ID="gvRoomType" runat="server"
                                                ...
                                                DataKeyNames="RoomType,ProcedureCode" OnRowCommand="gvRoomType_RowCommand" OnRowDeleting="gvRoomType_RowDeleting">
                                                <Columns>

                                                    <asp:TemplateField HeaderText="ProcedureCode">
                                                        <ItemTemplate>
