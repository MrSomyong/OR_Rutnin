<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Organ.aspx.cs" Inherits="solution.Setup.Organ" %>
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="#">Setup ORGAN Preset</a>
            </li>
        </ol>
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-tachometer"></i><span class="nav-link-text">Setup ORGAN Preset</span></h4>
            </div>
        </div>
        <hr />
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div style="overflow-y: hidden">
                            <asp:GridView ID="gvORGAN" runat="server" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found" AutoGenerateColumns="False"
                                CssClass="table table-striped table-bordered table-hover" OnRowCommand="gvORGAN_RowCommand">
                                <Columns>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card card-register mx-auto mt-3">
                                    <div class="card-header badge-warning">ORGAN</div>
                                    <div class="card-body" id="divSub" runat="server">

                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-2">
                                                    <label for="txtSubName">ORGAN</label>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>--%>
                                            <asp:GridView ID="gvORGANSub" runat="server"
                                                ShowHeaderWhenEmpty="True" EmptyDataText="No records Found"
                                                AutoGenerateColumns="False"
                                                CssClass="table table-striped table-bordered table-hover"
                                                DataKeyNames="SubCode,SubName" OnRowCommand="gvORGANSub_RowCommand" OnRowDeleting="gvORGANSub_RowDeleting" OnRowEditing="gvORGANSub_RowEditing">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button ID="Button4" runat="server" CssClass="btn btn-success btn-sm mousecursor" Text="Edit" CommandName="edit" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-danger btn-sm mousecursor" Text="Delete" OnClientClick="return confirm('Do you want to delete?')" CommandName="delete" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                        </ItemTemplate>
