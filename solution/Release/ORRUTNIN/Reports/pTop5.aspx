<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pTop5.aspx.cs" Inherits="solution.Reports.pTop5" %>
                    ...
                    <asp:GridView ID="gvData" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Operation">
                                ...
                                <HeaderStyle CssClass="text-center" />
                                <FooterTemplate>
                                   <asp:Label ID="lblSumAmount" runat="server" Text="รวม"></asp:Label>
                                </FooterTemplate>
