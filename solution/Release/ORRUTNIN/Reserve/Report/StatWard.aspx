<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatWard.aspx.cs" Inherits="solution.Reserve.StatWard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-bar-chart"></i><span class="nav-link-text">Stat Ward</span></h4>
            </div>
        </div>
        <hr />
        <div class="row">
        ...
        <asp:UpdatePanel runat="server" ID="upddl">
            <ContentTemplate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <asp:DropDownList ID="ddlAnesthesiaType" runat="server" AutoPostBack="true" CssClass="form-control input-group-sm" Visible="false">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-5">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvStatWard" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="No records Found" runat="server"
                                    CssClass="table table-striped table-bordered table-hover pre-scrollable" Width="100%" OnRowCreated="gvStatWard_RowCreated" ShowFooter="True">
                                    <Columns>
