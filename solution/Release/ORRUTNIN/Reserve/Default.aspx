<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="solution.Reserve.Default" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <button type="button" class="btn btn-warning" style="background-color: yellow; border-color: #808080"></button>
                &nbsp;แก้ไขหลังจาก <asp:Label ID="lblLateTime" runat="server" Text="15:30"></asp:Label>&nbsp;&nbsp;
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-inline">
                    ...
                    <div class="input-group" data-date="12/02/2019" data-date-format="dd/mm/yyyy">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvORRoom1" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="No records Found" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField CommandName="ed" Text="Edit" ControlStyle-CssClass="btn btn-success btn-sm" HeaderStyle-Width="100px" ItemStyle-CssClass="text-center">
