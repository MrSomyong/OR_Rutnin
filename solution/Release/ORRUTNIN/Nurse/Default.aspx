<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="solution.Nurse.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-user-circle"></i><span class="nav-link-text">Anesthesia Nurse</span></h4>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-2">
                                <label class="pull-right p-0">Nurse : </label>
                            </div>
                            <div class="col-10">
                                <asp:DropDownList ID="ddlNurse" runat="server" AutoPostBack="true" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <asp:GridView ID="gvNurse" runat="server" AutoGenerateColumns="False" EmptyDataRowStyle-BackColor="Orange"
                    ShowHeaderWhenEmpty="True" EmptyDataText="No records Found"
                    DataKeyNames="ID, Nurse, Name, StartAnesthesiaDateTime, Reamrk, strStartAnesthesiaDateTime"
                    CssClass="table table-striped table-bordered table-hover" OnRowDeleting="gvNurse_RowDeleting">
                    <Columns>
