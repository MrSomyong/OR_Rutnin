<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ORRoom.aspx.cs" Inherits="solution.Setup.ORRoom" %>
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="/Setup/ORRoom/">OR Room</a>
            </li>
        </ol>
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-cog"></i><span class="nav-link-text">OR Room</span></h4>
            </div>
        </div>
        <hr />
                ...
                <ContentTemplate>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox ID="txtCODE" runat="server" CssClass="form-control form-control-sm">                                            
                                </asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-3 text-right">
                                <label class="pull-right">RoomType :</label>
                            </div>
                            <div class="col-md-6">
                                <asp:DropDownList ID="ddlCodeType" runat="server" CssClass="form-control form-control-sm">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <asp:GridView ID="gvSetup" runat="server"
                                    ...
                                    DataKeyNames="ID,CODE,Name,CodeType,CodeTypeName"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="RoomType" HeaderStyle-CssClass="text-center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCodeTypeName" runat="server" Text='<%# Eval("CodeTypeName") %>'></asp:Label>
                                                <asp:HiddenField ID="hdCodeType" runat ="server" Value='<%# Eval("CodeType") %>' />
                                            </ItemTemplate>
                                            <ItemStyle CssClass="word-break text-center" Font-Size="Small" />
                                            <HeaderStyle Font-Size="Small" />
                                        </asp:TemplateField>
