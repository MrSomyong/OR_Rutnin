<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewAccessMenu.aspx.cs" Inherits="solution.AccessMenu.NewAccessMenu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">New Access Menu Setup</li>
        </ol>
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-user"></i><span class="nav-link-text">ลงทะเบียนรายการกลุ่มผู้ใช้งานระบบ</span></h4>
            </div>
            <div class="col-md-6">
        ...
        <div class="card card-body mx-auto mt-2">
            ...
            <div class="form-group">
                <div class="form-row text-center p-2">
                    <div class="col-md-12">
                        <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" Text="Save Access Menu" OnClick="btnSave_Click" />
                    </div>
                </div>
            </div>
        </div>
