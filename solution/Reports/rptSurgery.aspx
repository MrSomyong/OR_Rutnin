...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-bar-chart"></i><span class="nav-link-text">รายงานทะเบียนการผ่าตัด</span></h4>
            </div>
        </div>
        <hr />
        <div class="row">
                ...
                <div class="col-12">
                    <asp:GridView ID="gvData" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="No records Found" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="VN/AN">
                                <ItemTemplate>
                                    <asp:Label ID="lblANVN" runat="server" Text='<%# Eval("VisitID") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Wrap="false" CssClass="text-left" />
                                <HeaderStyle CssClass="text-center" />
                            </asp:TemplateField>
