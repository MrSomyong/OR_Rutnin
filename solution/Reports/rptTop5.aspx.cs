...
{
    public partial class rptTop5 : System.Web.UI.Page
    {
        ...
        private void loadvalue()
        {
            try
            {
                ...
                List<ORHEADERVO> lstORHEADERVO = new BLORHEADER(dbInfo).SearchrptTop5(DateFrom, DateTo, ddlCxlCheck.SelectedValue, ddlCxlConfirm.SelectedValue);
                gvData.DataSource = lstORHEADERVO;
                gvData.DataBind();
                Session["gvrptTop5"] = lstORHEADERVO;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {
            //loadvalue();
            Response.Redirect("/Reports/pTop5/", false);
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=รายงานจัดอันดับ Top 5.xls");
