...
{
    public partial class rptIndicatorProcedure : System.Web.UI.Page
    {
        ...
        private void loadvalue()
        {
            try
            {
                ...
                List<ORHEADERVO> templstORHEADERVO = new BLORHEADER(dbInfo).SearchrptIndicatorProcedure(DateFrom, DateTo, ddlCxlCheck.SelectedValue, ddlCxlConfirm.SelectedValue);
                ...
                gvData.DataBind();
                Session["gvrptIndicatorProcedure"] = lstORHEADERVO;
        ...
        {
            //loadvalue();
            Response.Redirect("/Reports/pIndicatorProcedure/", false);
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=รายงานIndicatorแยกตามแพทย์และProcedure.xls");
