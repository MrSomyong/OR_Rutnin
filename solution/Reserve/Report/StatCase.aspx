<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StatCase.aspx.cs" Inherits="solution.Reserve.StatCase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-bar-chart"></i><span class="nav-link-text">Stat Case</span></h4>
            </div>
        </div>
        <hr />
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-left:10px;padding-right:10px">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvStatCase" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="No records Found" runat="server"
                                    CssClass="table table-striped table-bordered table-hover pre-scrollable" Width="100%" OnRowCreated="gvStatCase_RowCreated" ShowFooter="True">
                                    <Columns>
                                        <asp:BoundField HeaderText="Doctor" DataField="Surgeon1">
                                        ...
                                        <asp:BoundField HeaderText="Procedure" DataField="HN">
                                            <HeaderStyle CssClass="text-center" />
                                            <ItemStyle CssClass="text-center" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Procedure" DataField="PatientName">
                                            <HeaderStyle CssClass="text-center" />
                                            <ItemStyle CssClass="text-left" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Operation DateTime" DataField="strORDate">
                                            <HeaderStyle CssClass="text-center" />
                                            <ItemStyle CssClass="text-center" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Make DateTime" DataField="strCreateDate">
                                            <HeaderStyle CssClass="text-center" />
                                            <ItemStyle CssClass="text-center" />
                                        </asp:BoundField>
