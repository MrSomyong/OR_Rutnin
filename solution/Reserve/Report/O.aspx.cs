    ...
    public partial class O : System.Web.UI.Page
    {
        ...
        private void loadvalue()
        {
            try
            {
                ...
                List<ORHEADERVO> lstORHEADERVO = new BLORHEADER(dbInfo).SearchOperation(ORHEADERVO);

                gvOperation.DataSource = lstORHEADERVO;
                ...
                Session["gvOp"] = gvOperation;
                Session["gvOperation"] = lstORHEADERVO;
        ...
        {
            //loadvalue();
            Response.Redirect("/Reserve/Report/O_Print/", false);
