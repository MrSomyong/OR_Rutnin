<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="solution.Reserve.Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">เพิ่มจองห้อง</li>
        </ol>
        <div class="row">
            <div class="col-md-6">
                <h4><i class="fa fa-fw fa-calendar"></i><span class="nav-link-text">บันทึการจองห้อง</span></h4>
            </div>
            <div class="col-md-6">
                ...
                <div class="btn-toolbar pull-right" role="toolbar" aria-label="Toolbar with button groups">
                    ...
                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <asp:Button ID="btnClear" class="btn btn-secondary pull-right" runat="server" Text="Clear" OnClick="Clear_Click" />

                    </div>

                    <div class="btn-group mr-2" role="group" aria-label="First group">
                        <asp:Button ID="btnCancel" class="btn btn-warning pull-right" runat="server" Text="Cancel" OnClick="Cancel_Click" />
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="row" hidden>
                        <div class="col-md-1">
                            <label for="ddlHN">ค้นหา</label>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="input-group">
                                    <asp:TextBox AutoPostBack="true" ID="txtSearchHN" runat="server" CssClass="form-control input-group-sm" placeholder="Search HN..." OnTextChanged="txtSearchHN_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <%--<div class="form-group">
                                <asp:DropDownList ID="ddlHN" runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlHN_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>--%>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <asp:TextBox AutoPostBack="true" ID="txtHN" runat="server" CssClass="form-control input-group-sm" OnTextChanged="txtSearchHN_TextChanged"></asp:TextBox>
                        ...
                        <div class="col-5">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6 pl-1 pl-1">
                                        <asp:UpdatePanel ID="upSearchSuggestByUser" runat="server">
                                            <ContentTemplate>
                                        ...
                                        <div style="overflow-y: scroll; height: 300px;">
                                            <asp:GridView ID="gvOROperation" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-danger btn-sm mousecursor" Text="ลบ" CommandName="delete" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
