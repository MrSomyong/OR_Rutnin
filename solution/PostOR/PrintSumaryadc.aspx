<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintSumaryadc.aspx.cs" Inherits="solution.PostOR.PrintSumaryadc" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divORHeader" style="font-size: 1.5rem;">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4" style="font-size: 1.5rem;">
                            <asp:Label ID="Label5" runat="server" Font-Size =15>Nationality :</asp:Label>
                            <asp:Label ID="lblNationality" Font-Bold="true" runat="server" Font-Size =25></asp:Label>
                        </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-8" style="border-right: 1px solid #e9ecef; font-size: 1.5rem;">
                    <div class="form-group mt-2">
            ...
            <div class="col-md-4">
                <span class="auto-style1">Operation ADC / Print : </span> <asp:Label ID="PrintDate" runat="server" Font-Bold="true" CssClass="auto-style1"></asp:Label>
            </div>
        </div>
