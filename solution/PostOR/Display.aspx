        ...
        <div class="row" style="font-size: 1.5rem;">
            ...
            <div class="col-md-6">
                <div class="btn-toolbar pull-right" role="toolbar" aria-label="Toolbar with button groups">
                    <asp:LinkButton ID="lnkbtnPrintAdc" runat="server" CssClass="btn btn-sm btn-primary pull-right m-1" OnClick="lnkbtnPrintAdc_Click" OnClientClick="SetTarget()"><i class="fa fa-2x fa-print" aria-hidden="true"></i>  Print Display ADC</asp:LinkButton>
                </div>
                <div class="btn-toolbar pull-right" role="toolbar" aria-label="Toolbar with button groups">
