...
{
    public partial class HNIdentify : System.Web.UI.Page
    {
        ...
        private List<ORHEADERVO> loadORHeader(string orid)
        {
            ...
            foreach (ORHEADERVO ORHEADERVO in templstORHEADERVO)
            {
                ...
                {
                    r = r + " : "+ "<b><font size=2px>" + EnumOR.ORSide.RE.ToString() + "</font></b>";
                }
                if (!string.IsNullOrEmpty(l))
                {
                    ...
                    if (!string.IsNullOrEmpty(r))
                        _br = "<br/>";
                    l = _br + l + " : " + "<b><font size=2px>" + EnumOR.ORSide.LE.ToString() + "</font></b>";
                }
                if (!string.IsNullOrEmpty(b))
                {
                    ...
                    if (!string.IsNullOrEmpty(l) || !string.IsNullOrEmpty(r))
                        _br = "<br/>";
                    b = _br + b + " : " + "<b><font size=2px>" + EnumOR.ORSide.BE.ToString() + "</font></b>";
                }
                if (!string.IsNullOrEmpty(None))
                {
                    ...
                    if (!string.IsNullOrEmpty(l) || !string.IsNullOrEmpty(r) || !string.IsNullOrEmpty(b))
                        _br = "<br/>";
                    None = _br + None + " : " + "<b><font size=2px>" + EnumOR.ORSide.None.ToString() + "</font></b>";
                }
                if (!string.IsNullOrEmpty(NA))
                {
                    ...
                    if (!string.IsNullOrEmpty(l) || !string.IsNullOrEmpty(r) || !string.IsNullOrEmpty(b) || !string.IsNullOrEmpty(None))
                        _br = "<br/>";
                    NA = _br + NA + " : " + "<b><font size=2px>" + EnumOR.ORSide.ยังไม่ระบุตา.ToString() + "</font></b>";
                }
