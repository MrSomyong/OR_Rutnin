...
{
    public partial class prtReport : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Request.QueryString["d"] != null)
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        //}
                        //Microsoft.Win32.RegistryKey mySystemPrinters = Microsoft.Win32.Registry.Users.OpenSubKey(@".DEFAULT\Software\Microsoft\Windows NT\CurrentVersion\Devices");
                        ...
                        //ReportDocument crystalReport = new ReportDocument();
                        string pathorrom = Server.MapPath("/") + "/Report/Report/ORROOM.rpt";
                        crystalReport.Load(pathorrom);

                        DataSet dsCustomers = GetDataReportByDate(Ordate);
        ...
        private void MapDll()
        {
            ...
            cboCurrentPrinters.DataSource = new BLSETUPPRINTER(dbInfo).SearchAll();
            cboCurrentPrinters.DataValueField = "ID";
            cboCurrentPrinters.DataTextField = "NAME";
        ...
        private DataSet GetDataReportByDate(DateTime Ordate)
        {
            DataSet ds = new DataSet();
            try
            {
                DataTable dtheader = new BLORHEADER(dbInfo).SearchByDate_DS(Ordate);
