<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="solution.EnquirePriceMain.Main" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-11">
                <h5><i class="fa fa-fw fa-calendar"></i><span class="nav-link-text">Enquiry Price With Patient</span></h5>
            </div>

            <div class="col-md-1">
                     <div class="btn-group mr-2" role="group" aria-label="First group">
                        <asp:Button ID="btnDeleteTreatment" class="btn btn-warning pull-right" Style="cursor: pointer;" runat="server" Text="Clear Data" CommandName="delTreatment" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" OnClientClick="return confirm('Confirm to clear data from vn?');" OnClick="btnDeleteTreatment_Click" />
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="row">
                                ...
                                <div class="row justify-content-end my-2 float-right">--%>
                                    <div class="col-6">
                                        <asp:HyperLink ID="lnkMain" runat="server"  CssClass="btn btn-info btn-sm px-3 mr-2"  NavigateUrl="~/EnquirePrice/Main.aspx">
                                    ...
                                    <div class="col-6">
                                        <div class="text-center pb-0">
                                            <div class="title ">
                                                <h4>รวมทั้งหมด (ENQUIRE ESTIMATE)
...
<%--            <div class="menu-button">
            ...
            <div class="panel">
                <ul class="nav nav-tabs">
                      ...
                      <li class="nav-item">
                        <a class="nav-link text-center" href="#chargedetailall" style="width: 200px;background-color: lightyellow;">Enq : all charge detail</a>
                    </li>
                   <li class="nav-item">
                        <a class="nav-link text-center" href="#chargedetail" style="width: 200px;background-color: lightyellow;">Enq : charge detail</a>
                    </li>

                    <li class="nav-item ">
                        <a class="nav-link text-center" href="#alltreatment" style="width: 200px;background-color: lightyellow;">Enq : all treatment</a>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link text-center" href="#df" style="width: 200px;background-color: lightyellow;">Enq : df treatment</a>
                    </li>
                     <li class="nav-item">
                        <a class="nav-link text-center" href="#medicine" style="width: 200px;background-color: lightyellow;">Enq : medicine</a>
                    </li>
                    ...
                    <div id="chargedetail" class="tab-pane fade">
                        ...
                        <div class="panel">
                            ...
                            <div class="text-center pb-5">
                                <div class="title ">
                                    <h3>รวมทั้งหมด (ENQUIRE ESTIMATE)
