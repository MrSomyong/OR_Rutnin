<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostGroupMethod.aspx.cs" Inherits="solution.EnquirePricePostGroupRequest.PostGroupMethod" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Enquiry Price Group Request</li>
        </ol>
        <div class="row">
            <div class="col-md-6">
                     ...
                     <%--<div class="menu-button">
                        <div class="row justify-content-end my-1 float-right">--%>
                            <div class="col-12">
                                ...
                                <asp:HyperLink ID="lnkGroup" runat="server"  CssClass="btn btn-info btn-sm px-3 mr-2"  NavigateUrl="~/EnquirePrice/PostGroupMethod.aspx">
          ...
          <%-- <div class="menu-button">
            ...
            <div class="panel">
                <ul class="nav nav-tabs">
                    <li class="nav-item ">
                        <a class="nav-link text-center" href="#treatment" style="width: 200px;background-color: lightyellow;">Enq : group method</a>
                    </li>
                    <%--  <li class="nav-item">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div style="overflow-y: scroll; overflow-x: auto; height: 450px;" class="table-responsive text-nowrap">
                                                                        <div class="panel">
                                                                            <ul class="nav nav-tabs">
                                                                                <li class="nav-item ">
                                                                                    <a class="nav-link text-center" href="#treatmentTab" style="width: 175px">Treatment</a>
                                                                                </li>
                                                                            ...
                                                                            <div class="tab-content">
                                                                                <div id="treatmentTab" class="tab-pane fade in active pt-3 pb-3">
