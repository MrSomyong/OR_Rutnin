<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostMedicine.aspx.cs" Inherits="solution.EnquirePostMedicine.PostMedicine" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Enquiry Medicine</li>
        </ol>
         <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="row">
                                ...
                                <div class="row justify-content-end my-1 float-right">--%>
                                    <div class="col-12">
                                        ...
                                        <asp:HyperLink ID="lnkMedicine" runat="server"  CssClass="btn btn-info btn-sm px-3 mr-2"  NavigateUrl="~/EnquirePrice/PostMedicine.aspx">
