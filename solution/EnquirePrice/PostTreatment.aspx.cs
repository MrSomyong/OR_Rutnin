...
namespace solution.EnquirePricePostTreatment
{
    public partial class PostTreatment : System.Web.UI.Page
    {
        ...
        public void LoadOPDVisitInfo(VT_VNMASTER _VT_VNMASTER)
        {
            try
            {
                ...
                TreatmentPriceType = VT_VNMASTER.TreatmentPriceType;
                MedicinePriceType = VT_VNMASTER.MedicinePriceType;
        ...
        public void LoadOPDTreatmentList(VT_VNTREAT_TEMP _VT_VNTREAT)
        {
            try
            {
                List<VT_VNTREAT_TEMP> lstVNTREAT = new BLVT_VNTREAT_TEMP(extConnDBInfo,appConnDBInfo).GetAllVNTreatByKey(_VT_VNTREAT, true);
