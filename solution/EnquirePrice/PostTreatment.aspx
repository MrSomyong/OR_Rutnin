<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostTreatment.aspx.cs" Inherits="solution.EnquirePricePostTreatment.PostTreatment" %>
                               ...
                               <%--<div class="menu-button">
                                <div class="row justify-content-end my-1 float-right">--%>
                                    <div class="col-12">
                                        ...
                                        <asp:HyperLink ID="lnkTreatment" runat="server"  CssClass="btn btn-info btn-sm px-3 mr-2"  NavigateUrl="~/EnquirePrice/PostTreatment.aspx">
                                             <span class="text">Treatment</span>
                                        </asp:HyperLink>
                                        <asp:HyperLink ID="lnkDF" runat="server"  CssClass="btn btn-secondary btn-sm px-3 mr-2"  NavigateUrl="~/EnquirePrice/PostDF.aspx">
...
<%--           <div class="menu-button">
            ...
            <div class="panel">
                <ul class="nav nav-tabs">
                    <li class="nav-item ">
                        <a class="nav-link text-center" href="#treatment" style="width: 200px;background-color: lightyellow;">Enq : treatment</a>
                    </li>
                    <%--  <li class="nav-item">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal">
                                                                <div class="control-group row-fluid form-inline alert  alert-success">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <asp:DropDownList ID="ddlTreatmentMethod" runat="server" AutoPostBack="true" CssClass="form-control d-block"  OnSelectedIndexChanged="ddlTreatmentMethod_SelectedIndexChanged"></asp:DropDownList>
                                                                    </div>
