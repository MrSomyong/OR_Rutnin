<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="solution.PostMedicine.Default" %>
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="/PostTreatment/">Visit Search / Patient List</a>
            </li>
        </ol>
        <div class="row">
            <div class="col-md-9">
                <h4><i class="fa fa-fw fa-calendar"></i><span class="nav-link-text">Visit Search / Patient List</span></h4>
            </div>
            <div class="col-md-3">
                <asp:Label ID="IPAddress" runat="server" Font-Bold="true" Visible ="false"></asp:Label><asp:Label ID="ComputerName" runat="server" Font-Bold="true"  Visible ="false"></asp:Label>
            </div>
        </div>
        <hr />
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <asp:HiddenField ID="hdComputerName" runat="server" />
          ...
          <div class="row my-3">
            <div class="col-md-2 text-right">
              ...
              <div class="col-md-3">
                  <div class="form-horizontal">
                      <div class="control-group form-inline ">
                          <asp:DropDownList ID="ddlPaidOut" runat="server" AutoPostBack="false" CssClass="form-control d-block">
                              <asp:ListItem Text="All" Value=" " />
                              <asp:ListItem Text="Exclude Paid" Value="0" />
                              <asp:ListItem Text="Only Paid" Value="1" />
                          </asp:DropDownList>
                      </div>
                  </div>
              </div>
             <div class="col-md-2 text-right">
              ...
              <div class="col-md-3">
                  <asp:DropDownList ID="ddlCloseVisit" runat="server" AutoPostBack="false" CssClass="form-control d-block">
                      <asp:ListItem Text="All" Value=" " />
                      <asp:ListItem Text="Exclude Close Visit" Value="0" />
                      <asp:ListItem Text="Only Close Visit" Value="1" />                
                  </asp:DropDownList>
              </div>
              <div class="col-md-2 text-right">
