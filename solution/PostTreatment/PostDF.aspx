<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostDF.aspx.cs" Inherits="solution.PostTreatment.PostDF" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Post Doctor Treatment</li>
        </ol>
         <div class="row">
            <div class="col-md-6">
...
<%--            <div class="clearfix"></div>--%>
            <div class="row">
                ...
                <div class="row justify-content-end my-1 float-right">
                    <div class="col-12">
                        ...
                        <asp:HyperLink ID="lnkDF" runat="server"  CssClass="btn btn-info btn-sm px-3 mr-2"  NavigateUrl="~/PostTreatment/PostDF.aspx">
            ...
            <div class="panel">
                <ul class="nav nav-tabs">
                    <li class="nav-item ">
                        <a class="nav-link text-center" href="#treatment" style="width: 175px">Doctor Treatment</a>
                    </li>
