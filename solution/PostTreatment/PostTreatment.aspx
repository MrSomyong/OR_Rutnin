<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostTreatment.aspx.cs" Inherits="solution.PostTreatment.PostTreatment" %>
            ...
            <div class="row">
                ...
                <div class="row justify-content-end my-1 float-right">
                    <div class="col-12">
                        ...
                        <asp:HyperLink ID="lnkTreatment" runat="server"  CssClass="btn btn-info btn-sm px-3 mr-2"  NavigateUrl="~/PostTreatment/PostTreatment.aspx">
                             <span class="text">Treatment</span>
                        </asp:HyperLink>
                        <asp:HyperLink ID="lnkDF" runat="server"  CssClass="btn btn-secondary btn-sm px-3 mr-2"  NavigateUrl="#">
                             <span class="text">DF</span>
                        </asp:HyperLink>
                        <asp:HyperLink ID="lnkMedicine" runat="server"  CssClass="btn btn-secondary btn-sm px-3 mr-2"  NavigateUrl="#">
                             <span class="text">Medicine</span>
                        </asp:HyperLink>
                        <asp:HyperLink ID="lnkGroup" runat="server"  CssClass="btn btn-secondary btn-sm px-3 mr-2"  NavigateUrl="#">
           ...
           <%--<div class="menu-button">
            ...
            <div class="panel">
                <ul class="nav nav-tabs">
                    <li class="nav-item ">
                        <a class="nav-link text-center" href="#treatment" style="width: 150px">Treatment</a>
                    </li>
                    <%--  <li class="nav-item">
                                    ...
                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal">
                                                                <div class="control-group row-fluid form-inline">
                                                                    <label class="control-label pull-right" style="min-width:100px;">Treatment : </label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div style="overflow-y: scroll; overflow-x: auto; height: 450px;" class="table-responsive text-nowrap">
                                                                ...
                                                                <asp:GridView ID="gvOPDTreatmentList" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="No records Found" runat="server"
                                                                    ...
                                                                    DataKeyNames="VN,VISITDATE,SUFFIX,SUBSUFFIX,CHARGECODE,TREATMENTCODE,TREATMENTENTRYSTYLE"
                                        ...
                                        <div class="col-md-5">
                                             <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-horizontal">
                                                                <div class="control-group row-fluid form-inline alert  alert-success">

                                                                    <label class="control-label pull-right">Treatment Method : </label>
                                                                    <div class="col-md-7 ">
                                                                        <asp:DropDownList ID="ddlTreatmentMethod" runat="server" AutoPostBack="true" CssClass="form-control d-block"  OnSelectedIndexChanged="ddlTreatmentMethod_SelectedIndexChanged" Height="20px"></asp:DropDownList>
                                                                    </div>
                                             ...
                                             <div class="row" style="padding-bottom: 50px;">
                                                        <div class="col-md-12">
                                                            <div style="overflow-y: scroll; overflow-x: auto; height: 500px;" class="table-responsive text-nowrap">
                                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                                    <ContentTemplate>
                                                                        <asp:GridView ID="gvTreatmentItem" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" EmptyDataText="No records Found" runat="server"
                                                                            CssClass="table table-striped table-bordered table-hover pre-scrollable"
                                                                             ShowFooter="true" 
                                                                            DataKeyNames="MethodCode , TreatmentCode"
                                                                            OnRowCommand="gvTreatmentItem_RowCommand" 
                                                                             OnRowCreated="gvTreatmentItem_RowCreated"
                                                                             OnRowDataBound="gvTreatmentItem_RowDataBound"
                                                                            >
                                                                            ...
                                                                            <Columns>
                                                                                  <asp:templatefield>   
                                                                                    ...
                                                                                    <itemtemplate>
                                                                                     ...
                                                                                     <FooterTemplate>
                                                                                       ...
                                                                                       <asp:Button ID="btnSubmitSelect" runat="server"  Text="Add Selected"  CssClass="btn btn-success btn-sm"  OnClick="btnSubmitSelect_Click"/>
                                                                                     </FooterTemplate>
                                                                                   </asp:templatefield>
                                                                                ...
                                                                                <asp:BoundField HeaderText="ChargeAmt." DataField="StdPrice1" DataFormatString="{0:N2}">
                                                                                    <HeaderStyle CssClass="text-center" />
                                                                                    <ItemStyle CssClass="text-right" />
                                                                                </asp:BoundField>
                                                                                <asp:BoundField HeaderText="TreatmentCode" DataField="TreatmentItemName">
                                                                                    <HeaderStyle CssClass="text-center" />
                                                                                    <ItemStyle CssClass="text-left" />
                                                                                </asp:BoundField>
                                                                    ...
                                                                    <%--<Triggers>
                                                                        <asp:AsyncPostBackTrigger ControlID="ddlTreatmentMethod" EventName="SelectedIndexChanged" />
   ...
   <script src="https://code.jquery.com/jquery-3.4.0.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            headerChk.click(function () {
                itemChk.each(function () {
                    ...
                    if (this.checked == true) {
                        $('#<%=gvTreatmentItem.ClientID %>').find("input:checkbox[Id*=chkSelect]").parent().parent().parent().addClass('highlightRow');
                        }
                        else {
                            $('#<%=gvTreatmentItem.ClientID %>').find("input:checkbox[Id*=chkSelect]").parent().parent().parent().removeClass('highlightRow');
                        }
                    })
                });
            ...
            $("#<%=gvTreatmentItem.ClientID%> input[id*='chkSelect']:checkbox").click(function () {
                if ($(this).is(':checked')) {
            ...
            $("#<%=ddlTreatment.ClientID%>").select2({
              ...
              placeholder: "Select Treatment",
                width: '100%',
                //openOnEnter: false, // killEvent removed from select2.js
                //selectOnClose: true ,
              allowClear: true

            });

            //$('#<%=ddlTreatment.ClientID%>').attr('disabled', 'disabled');
            if ($('#<%=ddlTreatment.ClientID%>').is(':disabled') == false) {
                setTimeout( function() {
            ...
            $('#<%=ddlTreatment.ClientID%>').on("click change keydown", function (e) { 
          ...
          $(".nav-tabs a").click(function () {
            ...
            $("#<%=txtQty.ClientID%> , #<%=txtAmt.ClientID%>").bind("focusout change", function () {
                CalculatePrice();
            });

             
            $("#<%=btnUpdateTreatment.ClientID%>").click(function(event){
    ...
    <script type="text/javascript">
        ...
        (function($){
             $(document).ready(function () {
                   ...
                   $("#<%=txtStartDateTime.ClientID%> , #<%=txtEndDateTime.ClientID%>").change(function () {
